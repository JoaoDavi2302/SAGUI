package com.ufpa.SAGUI.controller.lesson;
...
import com.ufpa.SAGUI.service.lesson.LessonService;
...
@Tag(name = "Aulas", description = "CRUD, consulta e conclusão de aulas")
...
public class LessonController {
    ...
    public ResponseEntity<LessonResponse> updateLesson(
            @PathVariable UUID id, @RequestBody @Valid LessonRequest request) {
